...
class RequestHelper
{
    ...
    const PARAM_IS_CONVERTJSON = 'is_convertjson';
    const PARAM_IS_CLONE = 'is_clone';
    ...
    const AVAILABLE_PARAMS = array(self::PARAM_INDENT_CHAR, self::PARAM_INDENT_SIZE, self::PARAM_NEWLINE_CHAR, self::PARAM_ORIGINAL,
        self::PARAM_IS_CONSTRUCTOR, self::PARAM_IS_TOARRAY, self::PARAM_IS_PASCALCASE, self::PARAM_IS_CONVERTJSON, self::PARAM_IS_CLONE);
    /**
